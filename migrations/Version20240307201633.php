 ...
 */
final class Version20240307201633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blocs_competences (id INT AUTO_INCREMENT NOT NULL, diplomes_id INT DEFAULT NULL, competences_id INT DEFAULT NULL, id_comp VARCHAR(8) NOT NULL, nom_bloc_comp VARCHAR(100) NOT NULL, description_bloc_comp VARCHAR(255) NOT NULL, INDEX IDX_EF2957A2A953C628 (diplomes_id), INDEX IDX_EF2957A2A660B158 (competences_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE blocs_connaissances (id INT AUTO_INCREMENT NOT NULL, diplomes_id INT DEFAULT NULL, connaissances_id INT DEFAULT NULL, id_conn VARCHAR(8) NOT NULL, nom_bloc_conn VARCHAR(10) NOT NULL, description_bloc_conn VARCHAR(255) NOT NULL, INDEX IDX_E9173582A953C628 (diplomes_id), INDEX IDX_E9173582ED19B04C (connaissances_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE competences (id INT AUTO_INCREMENT NOT NULL, ues_id INT DEFAULT NULL, ects_comp SMALLINT NOT NULL, description_comp VARCHAR(255) NOT NULL, INDEX IDX_DB2077CE5B75D6BC (ues_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE connaissances (id INT AUTO_INCREMENT NOT NULL, ues_id INT DEFAULT NULL, ects_conn SMALLINT NOT NULL, description_conn VARCHAR(255) NOT NULL, INDEX IDX_1B3105E85B75D6BC (ues_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mccrne (id INT AUTO_INCREMENT NOT NULL, session1 VARCHAR(100) NOT NULL, senconde_chance VARCHAR(100) NOT NULL, session2 VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE blocs_competences ADD CONSTRAINT FK_EF2957A2A660B158 FOREIGN KEY (competences_id) REFERENCES competences (id)');
        ...
        $this->addSql('ALTER TABLE blocs_connaissances ADD CONSTRAINT FK_E9173582ED19B04C FOREIGN KEY (connaissances_id) REFERENCES connaissances (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blocs_competences DROP FOREIGN KEY FK_EF2957A2A660B158');
        $this->addSql('ALTER TABLE blocs_connaissances DROP FOREIGN KEY FK_E9173582A953C628');
        $this->addSql('ALTER TABLE blocs_connaissances DROP FOREIGN KEY FK_E9173582ED19B04C');
