 ...
 */
final class Version20240402064811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blocs_connaissances (id INT AUTO_INCREMENT NOT NULL, diplomes_id INT DEFAULT NULL, id_conn VARCHAR(8) NOT NULL, nom_bloc_conn VARCHAR(100) NOT NULL, description_bloc_conn VARCHAR(255) NOT NULL, INDEX IDX_E9173582A953C628 (diplomes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mccrne (id INT AUTO_INCREMENT NOT NULL, session1 VARCHAR(100) NOT NULL, seconde_chance VARCHAR(100) NOT NULL, session2 VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ues (id INT AUTO_INCREMENT NOT NULL, utilisateurs_id INT DEFAULT NULL, mcc_id INT DEFAULT NULL, statut_id INT DEFAULT NULL, parcours_id INT DEFAULT NULL, reference VARCHAR(10) NOT NULL, semestre SMALLINT NOT NULL, titre VARCHAR(100) NOT NULL, ects SMALLINT NOT NULL, type VARCHAR(15) NOT NULL, prerequis VARCHAR(255) NOT NULL, cm INT NOT NULL, td INT NOT NULL, tp INT NOT NULL, effectif INT NOT NULL, groupe_cm SMALLINT NOT NULL, groupe_td SMALLINT NOT NULL, groupe_tp SMALLINT NOT NULL, INDEX IDX_7CFDCCCD1E969C5 (utilisateurs_id), INDEX IDX_7CFDCCCD6BA9F475 (mcc_id), INDEX IDX_7CFDCCCDF6203804 (statut_id), INDEX IDX_7CFDCCCD6E38C0DB (parcours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE blocs_competences ADD CONSTRAINT FK_EF2957A2A953C628 FOREIGN KEY (diplomes_id) REFERENCES diplomes (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE blocs_connaissances ADD CONSTRAINT FK_E9173582A953C628 FOREIGN KEY (diplomes_id) REFERENCES diplomes (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE competences ADD CONSTRAINT FK_DB2077CE5B75D6BC FOREIGN KEY (ues_id) REFERENCES ues (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE competences ADD CONSTRAINT FK_DB2077CE36265666 FOREIGN KEY (bloc_competences_id) REFERENCES blocs_competences (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE connaissances ADD CONSTRAINT FK_1B3105E85B75D6BC FOREIGN KEY (ues_id) REFERENCES ues (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE connaissances ADD CONSTRAINT FK_1B3105E892B24CAC FOREIGN KEY (bloc_connaissances_id) REFERENCES blocs_connaissances (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE parcours ADD CONSTRAINT FK_99B1DEE3A953C628 FOREIGN KEY (diplomes_id) REFERENCES diplomes (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE ues ADD CONSTRAINT FK_7CFDCCCD6BA9F475 FOREIGN KEY (mcc_id) REFERENCES mccrne (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ues ADD CONSTRAINT FK_7CFDCCCDF6203804 FOREIGN KEY (statut_id) REFERENCES statut (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ues ADD CONSTRAINT FK_7CFDCCCD6E38C0DB FOREIGN KEY (parcours_id) REFERENCES parcours (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE utilisateurs ADD CONSTRAINT FK_497B315EA953C628 FOREIGN KEY (diplomes_id) REFERENCES diplomes (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE utilisateurs ADD CONSTRAINT FK_497B315ED60322AC FOREIGN KEY (role_id) REFERENCES role (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ues DROP FOREIGN KEY FK_7CFDCCCD6E38C0DB');
