 ...
 */
final class Version20240402021736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ues_parcours (ues_id INT NOT NULL, parcours_id INT NOT NULL, INDEX IDX_AAB9BB475B75D6BC (ues_id), INDEX IDX_AAB9BB476E38C0DB (parcours_id), PRIMARY KEY(ues_id, parcours_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ues_parcours ADD CONSTRAINT FK_AAB9BB475B75D6BC FOREIGN KEY (ues_id) REFERENCES ues (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ues_parcours ADD CONSTRAINT FK_AAB9BB476E38C0DB FOREIGN KEY (parcours_id) REFERENCES parcours (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ues_parcours DROP FOREIGN KEY FK_AAB9BB475B75D6BC');
        $this->addSql('ALTER TABLE ues_parcours DROP FOREIGN KEY FK_AAB9BB476E38C0DB');
        ...
        $this->addSql('DROP TABLE ues_parcours');
